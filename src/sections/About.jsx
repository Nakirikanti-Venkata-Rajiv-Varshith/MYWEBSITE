        ...
        <div className="about-grid reveal">
          ...
          <div className="about-text">
            ...
            <div className="about-body">
              <p>
                I'm a Computational Engineering student at IIT Hyderabad, driven by curiosity
                and a love for technology. I enjoy building full‑stack applications, exploring
                AI systems, and learning modern DevOps practices.
              </p>
              <p>
                My interests span machine learning, backend systems, distributed computing,
                and scalable infrastructure — always aiming to bridge the gap between research
                and production.
              </p>
            </div>
